...
import { PATH_APPLY } from "@/constants/routes";
...
export default function LandingBanner() {
  return (
    <FallingLeavesBanner className="w-full px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
      <div className="mx-auto w-full max-w-6xl">
        <div className="max-w-2xl">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
            <CommonButton href={PATH_APPLY}>Get Started</CommonButton>
