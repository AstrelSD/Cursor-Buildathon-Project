    ...
    await _update_loan(
        loan_id,
        {
            ...
            "crop_health_matrix": {
                ...
                "vegetation_index": vision_result.vegetation_index,
                ...
                "image_quality_score": vision_result.image_quality_score,
                "crop_match_confidence": vision_result.crop_match_confidence,
                "canopy_cover_percent": vision_result.canopy_cover_percent,
